...
\newcommand{\eventname}[0]{AVM 2019}

% logos
% \newcommand{\logoleft}[0]{\hspace*{8mm}\includegraphics[width=2.8cm,keepaspectratio]{FIT_short_color_RGB_EN.png}}
\newcommand{\logoleft}[0]{\hspace*{2mm}\includegraphics[width=2.8cm,keepaspectratio]{FIT_abbreviation_color_PANTONE_EN.pdf}}
\newcommand{\logoright}[0]{\hspace*{-6mm}\includegraphics[width=1.8cm,keepaspectratio]{inf-lg-cze-rgb-cropped.png}}
\newcommand{\logoevent}[0]{\includegraphics[width=1.5cm,keepaspectratio]{avm-logo-color.pdf}}
...
\newcommand*{\SingleBadge}[1]{
  ...
  \begin{tikzpicture}
    ...
    \node at (\BadgeWidth / 2, \BadgeHeight - 0.45cm) {
      \textbf{\Large{\eventname}}};
    \node at (1, \BadgeHeight - 0.45cm) {\logoleft};
    % \node at (\BadgeWidth - 0.7cm, \BadgeHeight - 0.45cm) {\logoright};
    \node at (\BadgeWidth - 0.7cm, \BadgeHeight - 0.65cm) {\logoright};
    \node at (\BadgeWidth - 0.8cm, 0.8cm) {\logoevent};
    ...
    \node [anchor=north] at (\BadgeWidth / 2, 2.7) {\Large{\begin{tabular}{c}\affiliation\end{tabular}}};
